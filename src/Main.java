...
public class Main {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    //    new VisualizeImage(ImageToBufferedImageService.toBuffered(new ImageProcessorImpl().applySharpening(im2)));
    ...
    if (args.length != 0 && args[0].equals("-file")) {
      ...
      //      input = new TextInput(new ByteArrayInputStream(("load resources/raiden.jpg raiden\n"
      //          + "horizontal-flip raiden raidendither\n"
      //          + "sharpen raiden sharpened\n"
      //          + "save resources/raidsharp.jpg sharpened\n stop\n").getBytes()));
