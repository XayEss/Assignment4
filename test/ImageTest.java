...
public class ImageTest {
  ...
  public void testValidCreation() {
    Image testImage = new ImageUtil().readFile("resources/images/ppm_testing/testBaseImage.ppm");
  ...
  public void testGetImageChannel() {
    ...
    Image imageCh0 = new ImageUtil().readFile("resources/images/ppm_testing/testBaseImage_RedChannel.ppm");
    Image imageCh1 = new ImageUtil().readFile("resources/images/ppm_testing/testBaseImage_GreenChannel.ppm");
    Image imageCh2 = new ImageUtil().readFile("resources/images/ppm_testing/testBaseImage_BlueChannel.ppm");


    for (int row = 0; row < testImage.getHeight(); row++) {
      for (int col = 0; col < testImage.getWidth(); col++) {
        assertEquals(imageCh0.getPixelChannel(row, col, 0), testCh0.getPixelChannel(row, col, 0));
        assertEquals(imageCh1.getPixelChannel(row, col, 1), testCh1.getPixelChannel(row, col, 1));
        assertEquals(imageCh2.getPixelChannel(row, col, 2), testCh2.getPixelChannel(row, col, 2));
      }
    }
  }
  ...
  public void testFlipImage() {
    ...
    Image imageHorizontalFlipped = new ImageUtil().readFile("resources/images/ppm_testing/testBaseImage_HorizontalFlip.ppm");
    Image imageVerticalFlipped = new ImageUtil().readFile("resources/images/ppm_testing/testBaseImage_VerticalFlip.ppm");
  ...
  public void testGetValueImage() {
    ...
    for (int row = 0; row < testImage.getHeight(); row++) {
      for (int col = 0; col < testImage.getWidth(); col++) {
        ...
        assertEquals(testValueImage.getPixelChannel(row, col, 0), testValueImage.getPixelChannel(row, col, 1));
        assertEquals(testValueImage.getPixelChannel(row, col, 0), testValueImage.getPixelChannel(row, col, 2));
      }
    }
  }
  ...
  public void testGetLumaImage() {
    ...
    for (int row = 0; row < testImage.getHeight(); row++) {
      for (int col = 0; col < testImage.getWidth(); col++) {
        ...
        assertEquals(testLumaImage.getPixelChannel(row, col, 0), testLumaImage.getPixelChannel(row, col, 1));
        assertEquals(testLumaImage.getPixelChannel(row, col, 1), testLumaImage.getPixelChannel(row, col, 2));
      }
    }
  }
  ...
  public void testAlterBrightness() {
    ...
    for (int row = 0; row < testImage.getHeight(); row++) {
      for (int col = 0; col < testImage.getWidth(); col++) {
        assertEquals(testImage.getPixelChannel(row, col, 0) + 20, testIncreased.getPixelChannel(row, col, 0));
        assertEquals(testImage.getPixelChannel(row, col, 1) + 20, testIncreased.getPixelChannel(row, col, 1));
        assertEquals(testImage.getPixelChannel(row, col, 2) + 20, testIncreased.getPixelChannel(row, col, 2));

        // TODO: Negative value for alterBrightness? Pixel function working correctly - Check manipulationHelper
        assertEquals(testImage.getPixelChannel(row, col, 0) - 20, testDecreased.getPixelChannel(row, col, 0));
        assertEquals(testImage.getPixelChannel(row, col, 1) - 20, testDecreased.getPixelChannel(row, col, 1));
        assertEquals(testImage.getPixelChannel(row, col, 2) - 20, testDecreased.getPixelChannel(row, col, 2));
      }
    }
  }
  ...
  public void testGetGreyscaleImage() {
    ...
    for (int row = 0; row < testImage.getHeight(); row++) {
      for (int col = 0; col < testImage.getWidth(); col++) {
        ...
        assertEquals(testGreyscaleImage.getPixelChannel(row, col, 0), testGreyscaleImage.getPixelChannel(row, col, 1));
        assertEquals(testGreyscaleImage.getPixelChannel(row, col, 0), testGreyscaleImage.getPixelChannel(row, col, 2));
